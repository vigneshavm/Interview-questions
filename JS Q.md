...
| **Modules & DOM Manipulation**   | [innerHTML vs textContent](#innerhtml-vs-textcontent) • [CSS Manipulation](#css-manipulation) • [JS Modules (import/export)](#javascript-modules-importexport) • [CommonJS vs ES Modules](#commonjs-vs-es-modules)                              |
...
• [Global, Function, and Block Scope](#global-and-function-and-block-scope) 
