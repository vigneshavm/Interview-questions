...
| **Objects & Classes** | • [Constructor Function](#constructor-function)    • [new Keyword](#new-keyword)    • [Classical vs Prototypal Inheritance](#classical-vs-prototypal-inheritance)    • [Inheritance in ES2015 Classes](#inheritance-in-es2015-classes)    • [Static Class Members](#static-class-members)    • [Inheritance](#inheritance)    • [Prototype Pattern](#prototype-pattern)    • [Getters and Setters](#getters-and-setters)    • [Object.freeze / seal / preventExtensions](#objectfreeze-and-seal-and-preventextensions)    • [Optional Chaining (`?.`)](#optional-chaining-operator)    • [Nullish Coalescing (`??`)](#nullish-coalescing-operator)    • [in Operator vs hasOwnProperty()](#in-operator-vs-hasownproperty)    • [CommonJS vs ES Modules](#commonjs-vs-es-modules) |
