...
| [use strict Directive](#use-strict-directive)                    | [Generics](#generics)                                       | [Anonymous Functions](#anonymous-functions---use-cases)         |    | [Classical vs Prototypal Inheritance](#classical-vs-prototypal-inheritance) |      [Object Destructuring with Defaults](#object-destructuring-with-defaults)  |
| [Hoisting](#hoisting)                                            | [Union Types](#union-types)                                 | [Default Parameters](#default-parameters)                       |     | [Inheritance in ES2015 Classes](#inheritance-in-es2015-classes)   |         [Object.create() and Prototype Chains](#object-create-and-prototype-chains)           |
| [Lexical Scoping](#lexical-scoping)                              | [Type Inference](#type-inference)                           | [Higher-Order Functions](#higher-order-functions)               | | [Static Class Members](#static-class-members)                     |           |
...
| [null and undefined and undeclared](#null-and-undefined-and-undeclared) | [Duck Typing](#duck-typing)                                  | [Normal Function vs Arrow Function](#normal-function-vs-arrow-function)  | [Microtask Queue](#microtask-queue)                                          |                [Optional Chaining (`?.`) Operator](#optional-chaining-operator)                                                         | [Memoization Techniques](#memoization-techniques)                      |                                                                 |
| [Type Checking](#Type-Checking)                                  | [Module System & Compiler Options](#module-system--compiler-options) |                                                                  | [setTimeout() and setImmediate() and processnextTick()](#setTimeout-and-setImmediate-and-processnextTick) |                       [Nullish Coalescing (`??`) Operator](#nullish-coalescing-operator)                                                  | [Function Composition Patterns](#function-composition-patterns)        |                                                         |
| [== vs ===](#Loose-Equality-Vs-Strict-Equality)                  |          [this Keyword Behavior](#this-keyword-behavior)                     |                                                                   | | [Common Causes of Memory Leaks](#common-causes-of-memory-leaks) |  [Currying in JavaScript](#currying-in-javascript)                      | 
| [Mutable vs Immutable Objects](#mutable-vs-immutable-objects)    |                                                               [Key ES6 Features](#key-es6-features)  |  | [Shallow vs Deep Copy](#shallow-vs-deep-copy)  |   [JavaScript Garbage Collection](#javascript-garbage-collection)   |  [Debounce and Throttle Functions](#debounce-and-throttle-functions)    |
...
| [Type Checking](#Type-Checking)                                  | [Module System & Compiler Options](#module-system--compiler-options) | &nbsp;                                                           | [JavaScript Garbage Collection](#javascript-garbage-collection)             | [Nullish Coalescing (`??`) Operator](#nullish-coalescing-operator) | [Currying in JavaScript](#currying-in-javascript)         |
| [== vs ===](#Loose-Equality-Vs-Strict-Equality)                  | [this Keyword Behavior](#this-keyword-behavior)             | &nbsp;                                                           | &nbsp;                                                                       | &nbsp;                                                             | [Debounce and Throttle Functions](#debounce-and-throttle-functions) |
| [Mutable vs Immutable Objects](#mutable-vs-immutable-objects)    | [Key ES6 Features](#key-es6-features)                       | &nbsp;                                                           | &nbsp;                                                                       | &nbsp;                                                             | &nbsp; |
