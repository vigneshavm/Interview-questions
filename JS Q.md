...
| **DOM & Events** | • [Event Listeners](#event-listeners)    • [Bubbling vs Capturing](#event-bubbling)    • [preventDefault vs stopPropagation](#eventpreventdefault-vs-eventstoppropagation)    • [Event Delegation and Bubbling](#Event Delegation and Bubbling)    • [innerHTML vs textContent](#innerhtml-vs-textcontent)    • [CSS Manipulation](#manipulating-css-styles) |
