...
|------------------------------------------------------------------|--------------------------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------------------|-------------------------------------------------------------------|------------------------------------------------------------|
| [let and var and const](#let-and-var-and-const)                  | [How TypeScript Improves JavaScript](#how-typescript-improves-javascript) | [Function Declaration vs Expression vs Constructor](#function-declaration-vs-Expression-vs-Constructor) | [Synchronous vs Asynchronous](#synchronous-vs-asynchronous-functions)        | [Constructor Function](#constructor-function)                     | [Design Patterns](#introduction-to-design-patterns) |
| [Global JavaScript scope](#global-javascript-scope)              | [Interface vs. Type](#interface-vs-type)                     | [Arrow Functions](#arrow-functions)                             | [Promises](#promises)                                                        | [new Keyword](#new-keyword)                                       | [Object.assign() vs Spread Operator](#objectassign-vs-spread-operator)  |
| [use strict Directive](#use-strict-directive)                    | [Generics](#generics)                                       | [Anonymous Functions](#anonymous-functions---use-cases)         | [Async/Await](#asyncawait)                                                  | [Classical vs Prototypal Inheritance](#classical-vs-prototypal-inheritance) | [Object Destructuring with Defaults](#object-destructuring-with-defaults) |
| [Hoisting](#hoisting)                                            | [Union Types](#union-types)                                 | [Default Parameters](#default-parameters)                       | [Handling Async Errors](#Handling-Async-Errors)                              | [Inheritance in ES2015 Classes](#inheritance-in-es2015-classes)   | [Object.create() and Prototype Chains](#object-create-and-prototype-chains) |
| [Lexical Scoping](#lexical-scoping)                              | [Type Inference](#type-inference)                           | [Higher-Order Functions](#higher-order-functions)               | [Event Propagation](#event-propagation)                                     | [Static Class Members](#static-class-members)                     | [Dependency Injection](#dependency-injection)             |
| [Scope](#scope)                                                  | [Mapped Types](#mapped-types)                               | [Callback Functions](#callback-functions)                       | [Extending Built-in Objects](#extending-built-in-objects)                   | [Inheritance](#inheritance)                                     | [Event Loop & Call Stack](#event-loop--call-stack)        |
| [Global and Function and Block Scope](#global-and-function-and-block-scope) | [Custom Error](#custom-error)                               | [Closures](#Closures)                                           | [Microtask Queue](#microtask-queue)                                          | [Prototype Pattern](#prototype-pattern)                   | [call and apply and bind Methods](#call-and-apply-and-bind-Methods) |
| [Data Types](#data-types)                                        | [Request/Response Types](#requestresponse-types-with-typescript) | [Immediately Invoked Function Expressions](#immediately-invoked-function-expressions) | [setTimeout() and setImmediate() and processnextTick()](#setTimeout-and-setImmediate-and-processnextTick) | [Getters and Setters](#getters-and-setters)                       | [Pure Functions and Side Effects](#pure-functions-and-side-effects) |
| [Symbol](#symbol)                                                | [Decorators](#decorators)                                   | [JavaScript Modules (`import/export`)](#javascript-modules-importexport) | [Shallow vs Deep Copy](#shallow-vs-deep-copy)                                | [Object.freeze and seal and preventExtensions](#objectfreeze-and-seal-and-preventExtensions) | [Memoization Techniques](#memoization-techniques)          |
| [null and undefined and undeclared](#null-and-undefined-and-undeclared) | [Duck Typing](#duck-typing)                                 | [Normal Function vs Arrow Function](#normal-function-vs-arrow-function) | [Common Causes of Memory Leaks](#common-causes-of-memory-leaks)              | [Optional Chaining (`?.`) Operator](#optional-chaining-operator) | [Function Composition Patterns](#function-composition-patterns) |
| [Type Checking](#Type-Checking)                                  | [Module System & Compiler Options](#module-system--compiler-options) |  [WeakMap and WeakSet Usage](#weakmap-and-weakset-usage)                                                        | [JavaScript Garbage Collection](#javascript-garbage-collection)             | [Nullish Coalescing (`??`) Operator](#nullish-coalescing-operator) | [Currying in JavaScript](#currying-in-javascript)         |
| [== vs ===](#Loose-Equality-Vs-Strict-Equality)                  | [this Keyword Behavior](#this-keyword-behavior)             |[Temporal Dead Zone in `let` and const](#temporal-dead-zone-in-let-and-const)                                                      | [Type Coercion in Operations (`[] + [] and {}` + [])](#type-coercion-in-operations)                                                                       | [in Operator vs hasOwnProperty()](#in-operator-vs-hasownproperty)                                                        | [Debounce and Throttle Functions](#debounce-and-throttle-functions) |
| [Mutable vs Immutable Objects](#mutable-vs-immutable-objects)    | [Key ES6 Features](#key-es6-features)                       | [Difference Between Map and Plain Objects](#difference-between-map-and-plain-objects)                                                         | [Map Key References with Objects](#map-key-references-with-objects) ;                                                                       |[CommonJS vs ES Modules](#commonjs-vs-es-modules)                                                        | [ES6 Classes and Prototypal Inheritance](#es6-classes-and-prototypal-inheritance) |
...
| **Category**                          | **Topics**                                                                                                                                                                                                                                                                                                                                                                                                             |
|--------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **JavaScript Fundamentals**          | [let and var and const](#let-and-var-and-const), [Global JavaScript scope](#global-javascript-scope), [use strict Directive](#use-strict-directive), [Hoisting](#hoisting), [Lexical Scoping](#lexical-scoping), [Scope](#scope), [Global and Function and Block Scope](#global-and-function-and-block-scope), [Data Types](#data-types), [Symbol](#symbol), [null and undefined and undeclared](#null-and-undefined-and-undeclared), [Type Checking](#type-checking), [== vs ===](#loose-equality-vs-strict-equality), [Mutable vs Immutable Objects](#mutable-vs-immutable-objects) |
| **TypeScript**                       | [How TypeScript Improves JavaScript](#how-typescript-improves-javascript), [Interface vs. Type](#interface-vs-type), [Generics](#generics), [Union Types](#union-types), [Type Inference](#type-inference), [Mapped Types](#mapped-types), [Custom Error](#custom-error), [Request/Response Types](#requestresponse-types-with-typescript), [Decorators](#decorators), [Duck Typing](#duck-typing), [Module System & Compiler Options](#module-system--compiler-options), [this Keyword Behavior](#this-keyword-behavior), [Key ES6 Features](#key-es6-features) |
| **Functions & Scope**                | [Function Declaration vs Expression vs Constructor](#function-declaration-vs-expression-vs-constructor), [Arrow Functions](#arrow-functions), [Anonymous Functions](#anonymous-functions---use-cases), [Default Parameters](#default-parameters), [Higher-Order Functions](#higher-order-functions), [Callback Functions](#callback-functions), [Closures](#closures), [Immediately Invoked Function Expressions](#immediately-invoked-function-expressions), [JavaScript Modules (`import/export`)](#javascript-modules-importexport), [Normal Function vs Arrow Function](#normal-function-vs-arrow-function), [WeakMap and WeakSet Usage](#weakmap-and-weakset-usage), [Temporal Dead Zone in `let` and const](#temporal-dead-zone-in-let-and-const), [Difference Between Map and Plain Objects](#difference-between-map-and-plain-objects) |
| **Asynchronous JavaScript**          | [Synchronous vs Asynchronous](#synchronous-vs-asynchronous-functions), [Promises](#promises), [Async/Await](#asyncawait), [Handling Async Errors](#handling-async-errors), [Event Propagation](#event-propagation), [Extending Built-in Objects](#extending-built-in-objects), [Microtask Queue](#microtask-queue), [setTimeout() and setImmediate() and processnextTick()](#settimeout-and-setimmediate-and-processnexttick), [Shallow vs Deep Copy](#shallow-vs-deep-copy), [Common Causes of Memory Leaks](#common-causes-of-memory-leaks), [JavaScript Garbage Collection](#javascript-garbage-collection), [Type Coercion in Operations (`[] + [] and {}` + [])](#type-coercion-in-operations), [Map Key References with Objects](#map-key-references-with-objects) |
| **Objects & Classes**                | [Constructor Function](#constructor-function), [new Keyword](#new-keyword), [Classical vs Prototypal Inheritance](#classical-vs-prototypal-inheritance), [Inheritance in ES2015 Classes](#inheritance-in-es2015-classes), [Static Class Members](#static-class-members), [Inheritance](#inheritance), [Prototype Pattern](#prototype-pattern), [Getters and Setters](#getters-and-setters), [Object.freeze and seal and preventExtensions](#objectfreeze-and-seal-and-preventextensions), [Optional Chaining (`?.`) Operator](#optional-chaining-operator), [Nullish Coalescing (`??`) Operator](#nullish-coalescing-operator), [in Operator vs hasOwnProperty()](#in-operator-vs-hasownproperty), [CommonJS vs ES Modules](#commonjs-vs-es-modules) |
| **Design Patterns & Architecture**   | [Design Patterns](#introduction-to-design-patterns), [Object.assign() vs Spread Operator](#objectassign-vs-spread-operator), [Object Destructuring with Defaults](#object-destructuring-with-defaults), [Object.create() and Prototype Chains](#object-create-and-prototype-chains), [Dependency Injection](#dependency-injection), [Event Loop & Call Stack](#event-loop--call-stack), [call and apply and bind Methods](#call-and-apply-and-bind-methods), [Pure Functions and Side Effects](#pure-functions-and-side-effects), [Memoization Techniques](#memoization-techniques), [Function Composition Patterns](#function-composition-patterns), [Currying in JavaScript](#currying-in-javascript), [Debounce and Throttle Functions](#debounce-and-throttle-functions), [ES6 Classes and Prototypal Inheritance](#es6-classes-and-prototypal-inheritance) |
