| Category                          | Topics                                                                                                                                                                                                                                                                                                                                                                                                             |
|--------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Array 1 | • [Array Difference](#Array-Difference) • [Array Contains Duplicate Value](#Array-Contains-Duplicate-Value) • [Intersection of Two Arrays](#intersection-of-two-arrays) 
...
| Arrays | • [Two Sum](#two-sum)  • [Move Zeros](#move-zeros)     • [Maximum Subarray](#maximum-subarray)     • [Maximum Sum Subarray of Size K](#Maximum-Sum-Subarray-of-Size-K)        • [Maximum Product Subarray](#maximum-product-subarray)  • [Merge Sorted Arrays](#merge-sorted-arrays)  • [Rotate Array](#rotate-array)      
...
| Advance | • [Memoize](#Memoize) • [Type Coercion](#Type-Coercion)    • [Longest Consecutive Sequence](#longest-consecutive-sequence)  • [Set Matrix Zeroes](#set-matrix-zeroes)  • [Spiral Matrix](#spiral-matrix)  • [Subarray Sum Equals K](#subarray-sum-equals-k)
| Hash & Sets |•  • [Deep Clone an Object](#deep-clone-an-object) • [Custom `map()` Method](#custom-map-method) • [`var` vs `let` in Loops](#understanding-var-vs-let-in-loops-and-closures)  • [Retry Promise N Times](#retry-promise-n-times) 
