...
| [Attribute and Property](#difference-between-attribute-and-property-in-the-dom) | [`document.querySelector()` vs `getElementById()`](#documentqueryselector-and-documentgetelementbyid) | [Add, Remove, Modify HTML Elements](#add-remove-and-modify-html-elements-using-javascript) |  |  |  |  |  |
