...
| [Common Pitfalls of the `this` Keyword](#common-pitfalls-of-the-this-keyword) | [`this` Binding in Event Handlers](#this-binding-in-event-handlers) |  |  |  |  |  |  |
...
| [Code Coverage and Assessing Test Quality](#understanding-code-coverage-and-assessing-test-quality) | [Tools for JavaScript Testing](#tools-for-javascript-testing) |  |  |  |  |  |  |
