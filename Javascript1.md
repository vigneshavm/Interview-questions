...
| [Function Declaration vs Function Expression vs Constructor](#function-declaration-vs-function-call-vs-constructor-call)  | [Arrow Functions](#arrow-functions)  | [Anonymous Functions](#anonymous-functions---use-cases)  | [Default Parameters](#default-parameters)  | [Using AbortController to Abort Web Requests](#using-abortcontroller-to-abort-web-requests)  | [How JSONP Works](#how-jsonp-works)  |
| [AJAX](#ajax)  | [Advantages and Disadvantages of Using AJAX](#advantages-and-disadvantages-of-using-ajax)  | [Differences Between XMLHttpRequest and fetch()](#differences-between-xmlhttprequest-and-fetch) |
