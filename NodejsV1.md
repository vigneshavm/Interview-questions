...
| **REST API & Security**                    | [Secure Node.js App](#secure-nodejs-app), [REST API](#rest-api),[Secure REST APIs](#secure-rest-apis),  [HTTP methods & use cases](#http-methods--use-cases), [CORS](#cors),  [Manage security](#manage-security)   |
