...
| **Team Management** | - [Build and structure effective teams](#build-and-structure-effective-teams) - [Ensure code quality and maintainability from project start?](#ensure-code-quality-and-maintainability-from-project-start) |
