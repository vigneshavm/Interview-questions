...
|--------------|-----------|--------------|-----------|--------------|-----------|
| **Security** | [Security Application](#security-application) | **Scalability** | - | **Debugging**| - [Debugging & Troubleshooting Expertise](#debugging--troubleshooting-expertise)  -  [Troubleshooting, debugging and upgrading](#troubleshooting-debugging-and-upgrading-existing-software)|
...
| **Code Quality** |   - [Code quality](#lead-code-reviews)    - [Code coverage and Improvement strategies](#code-coverage-and-improvement-strategies) - [High Quality and Reuseble Code](#High-Quality-and-Reuseble-Code)|
...
| **Scalability** |  - [Scalability on AWS](#design-for-scalability-on-aws) 
