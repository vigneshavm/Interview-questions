...
| --- | :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| [What is Angular?](#1-what-is-angular) | 2. [Lifecycle Hooks](#2-lifecycle-hooks) | 3. [Modules (`@NgModule`)](#3-modules-ngmodule) | 4. [HTTP Interceptor](#4-http-interceptor) | 5. [Routing & Child Routes](#5-routing--child-routes) | 6. [Input & Output Decorators](#6-input--output-decorators)|
