...
| [$in Vs $all](#difference-between-in-and-all-in-mongodb) | [Searching in MongoDB](#searching-in-mongodb) | [Databases for a Social Media App](#databases-for-a-social-media-app) | [Capped Collection in MongoDB](#capped-collection-in-mongodb)
 | [Replication & Failover](#replication-and-how-failover-works-in-mongodb) |  |
