...
| **Props, State & Context**          | •  [Props ](#props-in-react) •  [Props Drilling](#props-drilling) 
•  [Props vs State](#props-vs-state) •  [React Children Prop](#react-children-prop) 
...
| **Forms and Validation**          | •  [Form Validation with Formik / React Hook Form](#Form-Validation-with-Formik) •  [Handling Multiple Inputs in a Form](#handling-multiple-inputs) |
| **Lists and DOM**          | •  [Keys in Lists](#keys-in-lists) •  [Virtual DOM](#virtual-dom) 
•  [Reconciliation Process](#reconciliation-process) •  [Refs ](#refs-in-react) 
...
| **Hook**          | •  [Lifecycle Methods](#lifecycle-methods) •  [React Hooks](#react-hooks) 
•  [Custom Hook](#Custom-Hook) •  [Higher-Order Components (HOCs)](#higher-order-components-hocs)  
...
•  [Avoiding Unnecessary Rerenders](#Avoiding-Unnecessary-Rerenders) •  [React Profiler](#react-profiler) 
